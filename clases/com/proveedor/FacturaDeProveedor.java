...
public class FacturaDeProveedor extends PedidoProveedorBase {

    @DefaultValueCalculator(CalculadorConsecutivoFacturaDeProveedor.class) // Fecha actual
    @ReadOnly
    int numero;
	
    @DefaultValueCalculator(CalculadorTipoFacturaProveedor.class) // Fecha actual
    @ReadOnly
