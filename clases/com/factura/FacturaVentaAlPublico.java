...
public class FacturaVentaAlPublico extends Factura {

    @DefaultValueCalculator(CalculadorConsecutivoFacturaVentaPublico.class) // Fecha actual
    @ReadOnly
    int numeroDeFactura;
	
    @DefaultValueCalculator(CalculadorTipoFacturaVentaPublico.class) // Fecha actual
    @ReadOnly
