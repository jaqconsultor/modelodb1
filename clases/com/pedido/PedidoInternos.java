...
@View(members= // Esta vista no tiene nombre, por tanto será la vista usada por defecto
"numeroDePedido, tipoDeDocumento,fecha;" + // Separados por coma significa en la misma línea
"coordinacionResponsable;" + // Punto y coma significa nueva línea
"detalles;totalCantidad" 
)

public class PedidoInternos extends PedidoBase {

    @DefaultValueCalculator(CalculadorConsecutivoPedido.class) // Fecha actual
    @ReadOnly
    int numeroDePedido;
    
    @DefaultValueCalculator(CalculadorTipoPedido.class) // Fecha actual
    @ReadOnly
