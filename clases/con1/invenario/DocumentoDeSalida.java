...
public class DocumentoDeSalida extends DocumentoInventarioBase {

    @DefaultValueCalculator(CalculadorConsecutivoDocSalida.class) // Fecha actual
    @ReadOnly
    int numeroDeDocumento;
    
    @DefaultValueCalculator(CalculadorTipoDocSalida.class) // Fecha actual
    @ReadOnly
