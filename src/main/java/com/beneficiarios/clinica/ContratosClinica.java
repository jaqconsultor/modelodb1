...
public class ContratosClinica extends Convenio {
...
//    @DefaultValueCalculator(CalculadorTipoFacturaAdministracion.class) // Fecha actual
	...
	EmpresasDeClinicaEsperanza empresaClinicaAsociada; // Una referencia Java convencional       

	@ListProperties("id, descripcion")
    @OneToMany(mappedBy="contratoDeLaClinica")
    Collection<BeneficiariosDeLaClinica> beneficiariosDeLaClinica;    
